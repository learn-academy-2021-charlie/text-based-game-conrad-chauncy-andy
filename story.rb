...
def option_left 
    "You have reached the river.. it is a rocky river with a fast current.. you want to cross the river and you have three options to do so option 1) a rickety bridge option2) an old boat option3) swim across please type your option number bellow ".each_char do |value|
        putc value 
        sleep 0.05
    end
puts
